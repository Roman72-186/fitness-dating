    ...
    >
      <div className="relative h-full w-full">
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 p-4 sm:p-5">
          <div className="rounded-[1.7rem] border border-white/10 bg-black/38 px-4 py-4 shadow-panel backdrop-blur-[10px]">
            <div className="flex items-end justify-between gap-3">
              <div className="min-w-0">
                <p className="mb-1 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-white/60">
                  Анкета
                </p>
                <h2 className="font-display text-[1.9rem] font-semibold leading-none text-white">
                  {profile.name}
                  {profile.age > 0 ? (
